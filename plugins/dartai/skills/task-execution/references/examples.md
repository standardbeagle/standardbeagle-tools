# Task Execution: Worked Examples & Step Details

Detailed step-by-step instructions for each phase of the execution pipeline. Loaded by the `task-execution` skill on demand when the executor enters that phase.

## Step -1: Read Project Rules (detail)
...
## Step 0: Read Domain Model (detail)
...
## Step 1: Read Grilled Task Spec (detail)
...
## Step 1.5: Refactor-First Assessment (detail)
...
## Step 2: Implement Changes — Strict TDD (detail)
...
## Step 3: Code Review (Self) — checklist
...
## Step 6: LCI Evaluation (detail + findability)
...
## Step 7: Refactor Check — checklist
...
## Step 8: Deprecated Cleanup (detail)

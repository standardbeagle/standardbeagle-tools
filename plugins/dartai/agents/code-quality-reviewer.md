...
When findings exceed the file budget, write detail to `.dartai/reports/<task-id>/quality-evidence.md` and reference it via the `evidence:` line in the verdict file.

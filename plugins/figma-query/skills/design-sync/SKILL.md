...
arguments: " - name: file_key description: \"Figma file key (from URL)\" required: true - name: output_dir description: \"Output directory (default: ./figma-export)\" required: false"
---

---
name: agnt-dev-proxy
description: "\"Start a dev server with reverse proxy for browser debugging. 啟開發服務器反向代理以調試瀏覽器. Use when: start dev proxy, set up reverse proxy, enable browser debugging, intercept network traffic, local dev with proxy\""

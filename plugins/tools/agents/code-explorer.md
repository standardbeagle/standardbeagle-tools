...
allowed-tools:
  ...
  - mcp__cs__context
  - mcp__cs__semantic_annotations
  - mcp__cs__side_effects
  - Read
  - Glob
---
...
1. **Get overview**: `mcp__cs__code_insight mode="overview"`
2. **Search for patterns**: `mcp__cs__search pattern="handleRequest"`
3. **Get symbol context**: `mcp__cs__get_context id="ABC" include_call_hierarchy=true`
4. **Analyze side effects**: `mcp__cs__side_effects mode="symbol" symbol_name="ProcessRequest"`
...
- Save context manifests for complex investigations: `mcp__cs__context operation="save"`

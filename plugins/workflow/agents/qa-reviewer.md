...
### 11. Return Format — Verdict File (file-streaming channel) 返回格式
...
**返回**：verdict 寫入檔 `.dartai/reports/<task-id>/qa.md`，按 `plugins/dartai/skills/verdict-schema.md` 規範（"Verdict File Delivery"）

---
name: mcp-tester-validate-schema
...
arguments: " - name: server description: Server name to validate required: true - name: tool description: Specific tool to validate (optional - validates all if omitted) required: false - name: input description: JSON input to validate against tool schema (optional) required: false"
---

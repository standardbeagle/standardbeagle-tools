...
arguments: " - name: server description: Filter logs to specific server (optional) required: false - name: direction description: Filter by direction - \"request\" or \"response\" (optional) required: false - name: limit description: Number of messages to show (default 20, max 500) required: false"
---
